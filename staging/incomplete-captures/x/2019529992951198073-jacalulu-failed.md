...
original_url: https://x.com/jacalulu/status/2019529992951198073
author: "Unknown"
handle: jacalulu
status_id: 2019529992951198073
captured_at: 2026-06-19T20:16:08+08:00
...
# Failed X capture for @jacalulu

## Source

- Original: [https://x.com/jacalulu/status/2019529992951198073](https://x.com/jacalulu/status/2019529992951198073)
- Canonical: [https://x.com/jacalulu/status/2019529992951198073](https://x.com/jacalulu/status/2019529992951198073)
...
Traceback (most recent call last):
  ...
  File "/opt/homebrew/Cellar/python@3.14/3.14.5/Frameworks/Python.framework/Versions/3.14/lib/python3.14/json/decoder.py", line 361, in raw_decode
    obj, end = self.scan_once(s, idx)
               ~~~~~~~~~~~~~~^^^^^^^^
json.decoder.JSONDecodeError: Unterminated string starting at: line 512 column 28 (char 64865)
```

## Referenced From

- `raw/intentional/pasted/sunder-sync-2026-06-11/108-new-files-original.md:142`
- `raw/intentional/pasted/sunder-sync-2026-06-11/138-urls-complete.md:78`
