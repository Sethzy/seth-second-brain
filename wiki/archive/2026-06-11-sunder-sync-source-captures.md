...
| 60 | gtm-sales | 116.6 MB | `CEASalespersonsPropertyTransactionRecordsresidential.csv` | Local-only oversized file; not committed to GitHub. Size/hash retained in `staging/sunder-sync/2026-06-11-data-files-manifest.json`. |
