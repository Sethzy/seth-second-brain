...
canonical_url: "https://cursor.com/blog/salesforce/"
vendor_blog: cursor
...
# Salesforce accelerates velocity by over 30% and ships higher-quality code with Cursor
Original URL: https://cursor.com/blog/salesforce/
...
Jan 21, 2026·[customers](/blog/topic/customers)

# Salesforce accelerates velocity by over 30% and ships higher-quality code with Cursor

Over 75% of developers at Salesforce now use Cursor, driving double-digit improvements in cycle time, PR velocity, and code quality.
...
* [Two paths toward Cursor adoption](#two-paths-toward-cursor-adoption)
* [Three metrics that matter most](#three-metrics-that-matter-most)
* [Shipping better products than ever](#shipping-better-products-than-ever)

Salesforce is a Software company in North America.

75%

Salesforce engineering adoption
...
Less time on legacy test coverage
...
Salesforce already had dashboards that tracked these metrics across thousands of engineers, making the impact of Cursor visible almost immediately. Cursor helped Salesforce make large improvements in all three areas. One team at Salesforce also [reduced legacy code coverage time by 85%](https://engineering.salesforce.com/how-cursor-ai-cut-legacy-code-coverage-time-by-85/).
...
If you're interested in leveraging AI to ship higher-quality software, faster, please [reach out to our team](https://cursor.com/contact-sales?source=customers) to get started with a Cursor trial.
