...
collected_at: 2026-06-13T10:49:26Z
...
Original URL: https://www.humanlayer.dev/blog/writing-a-good-claude-md
Fetched URL: https://www.humanlayer.dev/blog/writing-a-good-claude-md
Awesome Harness summary: A practical guide to creating durable, repo-local instructions that agents can repeatedly follow.

## Fetched Content

# # Writing a good CLAUDE.md

[Kyle](https://twitter.com/0xblacklight) · November 25, 2025 · < 10 min read
...
Verbose test and build output wastes tokens and confuses agents. A simple wrapper script can dramatically improve agent performance.](/blog/context-efficient-backpressure)[Older →
