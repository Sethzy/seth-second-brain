...
collected_at: 2026-06-13T10:49:17Z
...
Original URL: https://www.humanlayer.dev/blog/skill-issue-harness-engineering-for-coding-agents
Fetched URL: https://www.humanlayer.dev/blog/skill-issue-harness-engineering-for-coding-agents
Awesome Harness summary: A practical argument that weak results from coding agents are often harness problems rather than model problems.

## Fetched Content

# # Skill Issue: Harness Engineering for Coding Agents

[Kyle](https://twitter.com/0xblacklight) · March 12, 2026 · < 23 min read
...
![gpt-6](/blog/skill-issue/gpt-6.png)
...
![harness components](/blog/skill-issue/harness-components.png)
...
![harness engineering as context engineering](/blog/skill-issue/harness-engineering.png)
...
![working backwards from what models can't do natively](/blog/skill-issue/backwards.png)
...
![context firewall](/blog/skill-issue/context-firewall.png)
...
![terminal bench](/blog/skill-issue/terminal-bench.png)
...
![too many tools](/blog/skill-issue/too-many-tools.png)
...
![sub-agents](/blog/skill-issue/sub-agents.png)
...
![long context](/blog/skill-issue/long-context.jpg)
...
![limit case](/blog/skill-issue/limit-case.png)
...
![compaction](/blog/skill-issue/compaction.png)
...
![telephone](/blog/skill-issue/sub-agent-telephone.png)
...
Using conditional XML blocks to make Claude pay attention to the right instructions at the right time.](/blog/stop-claude-from-ignoring-your-claude-md)[Older →

### A Brief History of Ralph

January 6, 2026 · 10 min read

The Ralph Wiggum Technique went viral in the last week of 2025. Here's the story of ralph since the first time I met Geoff in June of 2025.](/blog/brief-history-of-ralph)
