...
canonical_url: "https://cursor.com/blog/warp-decode/"
vendor_blog: cursor
...
Original URL: https://cursor.com/blog/warp-decode/
...
Apr 6, 2026·[research](/blog/topic/research)

# Better MoE model inference with warp decode

By flipping the parallelism axis we achieve 1.8x faster and more accurate MoE model inference.

![](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Favatars%2Fless-wright.jpeg&w=48&q=70)
...
![](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Favatars%2Fzhiyuan-zhang.jpeg&w=48&q=70)

Less Wright, Federico Cassano & Zhiyuan Zhang · 10 min read

[![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/og/blog-warp-decode-anim-20260406-075700-600-optim.gif)](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/og/blog-warp-decode-anim-20260406-075700-1200.mp4)

### Table of Contents

↑

* [The conventional MoE path](#the-conventional-moe-path)
* [What we changed](#what-we-changed)
* [How the two kernels work](#how-the-two-kernels-work)
* [Pipeline simplification and acceleration](#pipeline-simplification-and-acceleration)
* [Stage Elimination](#stage-elimination)
* [Buffer elimination](#buffer-elimination)

* [Warp Independence](#warp-independence)
* [Results](#results)
* [End-to-end decode throughput at scale](#end-to-end-decode-throughput-at-scale)
* [Improved accuracy](#improved-accuracy)
* [Hardware Efficiency](#hardware-efficiency)
* [Warp decode and Composer training](#warp-decode-and-composer-training)
...
![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-traditional-data-flow-r4.svg)![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-traditional-data-flow-r4-dark.svg)
...
This warp independence lets warp decode run without any staging, handoffs, cross-warp sync points, or intermediate buffers. The entire MoE compute layer is compressed into two kernels, `moe_gate_up_3d_batched` and `moe_down_3d_batched`.

![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-data-flow-comparison-r4.svg)![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-data-flow-comparison-r4-dark.svg)
...
![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-architecture-r4.svg)![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-architecture-r4-dark.svg)
...
After all experts are processed, we reduce the 32 lane-local partial sums with a warp-level butterfly reduction using `__shfl_xor_sync`. This compiles directly to the PTX `shfl.sync.bfly` instruction, which is a single hardware primitive that exchanges registers between lanes within the warp, bypassing shared memory entirely.
...
#### [#](#elimination-of-padding)Elimination of padding
...
#### [#](#elimination-of-scatter-and-combine)Elimination of scatter and combine
...
![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-chart-throughput-gain-r4.svg)![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-chart-throughput-gain-r4-dark.svg)
...
![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-chart-fp32-ground-truth-r3.svg)![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-chart-fp32-ground-truth-r3-dark.svg)
...
![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-chart-throughput-r3.svg)![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/warp-decode-chart-throughput-r3-dark.svg)
