...
type: raw_capture
source_type: web
title: "Onyx docs welcome"
url: "https://docs.onyx.app/welcome?utm_source=onyx.app&utm_medium=cta&utm_campaign=main-site&utm_content=docs-button"
...
Source: https://docs.onyx.app/welcome?utm_source=onyx.app&utm_medium=cta&utm_campaign=main-site&utm_content=docs-button

## Capture Text

Extracted readable page text from HTML.

Welcome to Onyx! - Onyx Documentation
Documentation Index
...
Upcoming change:
Onyx is moving to group-based permissions. Curator and Global Curator roles will be removed.
See what's changing
Onyx Documentation
home page
Search...
...
To learn about other features, check out the
Core Features
section or visit the
Admin Docs
for an even more in depth breakdown.
​
Why Onyx?
