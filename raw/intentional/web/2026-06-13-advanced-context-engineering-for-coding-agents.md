...
collected_at: 2026-06-13T10:49:24Z
...
Source: https://www.humanlayer.dev/blog/advanced-context-engineering

## Capture Text

# Advanced Context Engineering for Coding Agents

Original URL: https://www.humanlayer.dev/blog/advanced-context-engineering
Fetched URL: https://www.humanlayer.dev/blog/advanced-context-engineering
Awesome Harness summary: HumanLayer patterns for reducing context drift and making coding sessions easier to resume.

## Fetched Content

# # Advanced Context Engineering for Coding Agents

[Dex](https://twitter.com/dexhorthy) · August 29, 2025 · < 20 min read

[#agents](/blog/tags/agents)[#claudecode](/blog/tags/claudecode)[#best-practices](/blog/tags/best-practices)
...
![Rework](/blog/advanced-context-engineering/ai-software-rework.png)
...
![Productivity](/blog/advanced-context-engineering/ai-software-productivity.png)
...
![Re-Steering](/blog/advanced-context-engineering/re-steering.png)
...
![Intentional Compaction](/blog/advanced-context-engineering/intentional-compaction.png)
...
![Compaction Output](/blog/advanced-context-engineering/output.png)
...
![Context is Everything](/blog/advanced-context-engineering/context-is-everything.png)
...
![Equation](/blog/advanced-context-engineering/equation.png)
...
![Sub-Agents](/blog/advanced-context-engineering/sub-agents.png)
...
![Telephone](/blog/advanced-context-engineering/telephone.png)
...
![Workflow](/blog/advanced-context-engineering/workflow.png)
...
![Quality Cascade](/blog/advanced-context-engineering/cascade.png)

So you want to **focus human effort and attention** on the HIGHEST LEVERAGE parts of the pipeline.

![Hierarchy of Leverage](/blog/advanced-context-engineering/leverage.png)
...
![Code Review Hierarchy of Needs](/blog/advanced-context-engineering/code-review-hierarchy-of-needs.png)
...
`CLAUDE.md` is a high-leverage configuration point for Claude Code. Learning how to write a good `CLAUDE.md` (or `AGENTS.md`) is a key skill for agent-enabled software engineering.](/blog/writing-a-good-claude-md)[Older →

### 12 Factor Agents

April 3, 2025 · 32 min read

The Original \*\*12 Factor Agents\*\* Manifesto. What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?](/blog/12-factor-agents)
