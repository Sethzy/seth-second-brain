...
Original URL: https://www.inngest.com/blog/your-agent-needs-a-harness-not-a-framework
Fetched URL: https://www.inngest.com/blog/your-agent-needs-a-harness-not-a-framework
Awesome Harness summary: Inngest's case for treating state, retries, traces, and concurrency as first-class infrastructure.

## Fetched Content

![Your Agent Needs a Harness, Not a Framework](/_next/image?url=%2Fassets%2Fblog%2Fyour-agent-needs-a-harness-not-a-framework%2Ffeatured-image.png&w=3840&q=75)

Blog Article

# Your Agent Needs a Harness, Not a Framework

Dan Farrelly•3/3/2026•13 min read
...
![Utah harness architecture](/_next/image?url=%2Fassets%2Fblog%2Fyour-agent-needs-a-harness-not-a-framework%2Futah-harness-architecture.png&w=3840&q=95)
...
![Utah harness functions](/_next/image?url=%2Fassets%2Fblog%2Fyour-agent-needs-a-harness-not-a-framework%2Futah-harness-functions.png&w=3840&q=95)
...
* [If it's local, why use Inngest? Why not just use OpenClaw?](#if-its-local-why-use-inngest-why-not-just-use-openclaw)
* [The agent loop as steps](#the-agent-loop-as-steps)
* [You don't need to build your own tools](#you-dont-need-to-build-your-own-tools)
* [Six functions, not one monolith](#six-functions-not-one-monolith)
* [Sub-agents via step.invoke()](#sub-agents-via-stepinvoke)
* [Singleton concurrency: one conversation at a time](#singleton-concurrency-one-conversation-at-a-time)
* [What we learned the hard way](#what-we-learned-the-hard-way)
* [What we're exploring next](#what-were-exploring-next)
* [Try it yourself](#try-it-yourself)

## Related content

[Back to learn center](/blog)

* [![](/_next/image?url=%2Fassets%2Fblog%2Fdebug-functions-terminal-cli-v2-rest-api%2Ffeatured-image.png&w=3840&q=75)
  ...
  Read Article→](/blog/debug-functions-terminal-cli-v2-rest-api)
* [![](/_next/image?url=%2Fassets%2Fblog%2Ftoo-many-javascript-schema-libraries-support-only-one%2Fcover.jpg&w=3840&q=75)
  ...
  Read Article→](/blog/too-many-javascript-schema-libraries-support-only-one)
* [![](/_next/image?url=%2Fassets%2Fblog%2Fannouncing-defers%2Ffeatured-image.png&w=3840&q=75)
  ...
  Read Article→](/blog/announcing-defer)

## Build better agents today

Add Inngest to your project in minutes. Free to start, no credit card required.

[Create free account](/sign-up?ref=blog)[Quick start guide →](/docs?ref=blog)
