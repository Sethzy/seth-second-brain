...
Original URL: https://cursor.com/blog/real-time-rl-for-composer/
...
Mar 26, 2026·[research](/blog/topic/research)

# Improving Composer through real-time RL

![](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Favatars%2Fjacob-jackson-avatar.png&w=48&q=70)

![](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Favatars%2Fben-trapani.jpeg&w=48&q=70)

![](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Favatars%2Fnathan-wang.jpeg&w=48&q=70)

![](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Favatars%2Fwanqi-zhu.png&w=48&q=70)

Jacob Jackson, Ben Trapani, Nathan Wang & Wanqi Zhu · 7 min read

[![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/og/blog-improving-composer-online-rl-anim-20260324-064314-1200-optim.gif)](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/og/blog-improving-composer-online-rl-anim-20260324-064314.mp4)

### Table of Contents

↑

* [The train-test mismatch](#the-train-test-mismatch)
* [A new checkpoint every five hours](#a-new-checkpoint-every-five-hours)
* [Real-time RL and reward hacking](#real-time-rl-and-reward-hacking)
* [Next up: learning from longer loops and specialization](#next-up-learning-from-longer-loops-and-specialization)
...
We call our approach of using real inference tokens for training "real-time RL." We first used this technique to [train Tab](/blog/tab-rl) and we found it was highly effective. Now we're applying a similar approach to Composer. We serve model checkpoints to production, observe user responses, and aggregate those responses as reward signals. This approach lets us ship an improved version of Composer behind Auto as often as every five hours.

![Chart showing Composer training score over successive checkpoints](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fimproving-composer-training-score-chart-v2-r6.png&w=1920&q=70)![Chart showing Composer training score over successive checkpoints](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fimproving-composer-training-score-chart-r6-v2-dark.png&w=1920&q=70)
...
At this point there's still a chance our updated version is worse than the previous one in unexpected ways, so we run it against our eval suites, including [CursorBench](/blog/cursorbench), to make sure there are no significant regressions. If the results are good, we deploy the checkpoint.
...
![Chart showing Composer edit percentage over time](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fimproving-composer-edit-pct-chart-r6.png&w=1920&q=70)![Chart showing Composer edit percentage over time](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fimproving-composer-edit-pct-chart-r6-dark.png&w=1920&q=70)
