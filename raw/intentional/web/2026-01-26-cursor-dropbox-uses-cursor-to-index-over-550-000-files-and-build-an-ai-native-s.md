...
type: raw_capture
source_type: web
title: "Dropbox uses Cursor to index over 550,000 files and build an AI-native SDLC"
url: "https://cursor.com/blog/dropbox/"
canonical_url: "https://cursor.com/blog/dropbox/"
vendor_blog: cursor
...
Original URL: https://cursor.com/blog/dropbox/
...
Jan 26, 2026·[customers](/blog/topic/customers)

# Dropbox uses Cursor to index over 550,000 files and build an AI-native SDLC

Dropbox accepts more than 1 million lines of agent generated code with Cursor every month, improving PR velocity and cycle time.
...
* [Organic adoption](#organic-adoption)
* [Leaders try the tools](#leaders-try-the-tools)
* [Indexing the monorepo](#indexing-the-monorepo)
* [A measurable impact on velocity](#a-measurable-impact-on-velocity)

Dropbox is a Software company in North America.

550K

Files indexed in Dropbox’s monorepo

1M+

Cursor-generated lines accepted monthly
...
If you're interested in embedding AI in every phase of the software development lifecycle, please [reach out to our team](https://cursor.com/contact-sales?source=customers) to get started with a Cursor trial.
