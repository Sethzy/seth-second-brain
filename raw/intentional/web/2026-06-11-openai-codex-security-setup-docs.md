...
type: raw_capture
source_type: web
title: "OpenAI Codex Security setup docs"
url: "https://developers.openai.com/codex/security/setup"
collected_at: 2026-06-10T17:10:44Z
...
# OpenAI Codex Security setup docs

Source: https://developers.openai.com/codex/security/setup

## Capture Text

Copy Page Codex Security setup
Set up Codex Security, wait for initial findings, and improve results with threat model edits
Copy Page This page walks you from initial access to reviewed findings and remediation pull requests in Codex Security.
...
Open environments 2. New security scan
After the environment exists, go to Create a security scan and choose the repository you just connected.
Create a security scan Codex Security scans repositories from newest commits backward first. It uses this to build and refresh scan context as new commits come in.
...
Review scans When the initial scan finishes, open the scan and review the threat model that was generated. After initial findings appear, update the threat model so it matches your architecture, trust boundaries, and business context. This helps Codex Security rank issues for your team.
...
Open findings You can use two views:
...
Review findings and create a PR Related docs
...
Previous Codex Security plugin Next Improving the threat model Ask AI Docs agent
Loading docs agent...
