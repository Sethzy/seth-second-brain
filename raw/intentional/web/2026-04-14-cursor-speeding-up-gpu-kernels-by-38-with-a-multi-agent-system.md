...
canonical_url: "https://cursor.com/blog/multi-agent-kernels/"
vendor_blog: cursor
...
Original URL: https://cursor.com/blog/multi-agent-kernels/
...
Apr 14, 2026·[research](/blog/topic/research)
...
Wilson Lin – Cursor; Sahil Modi, Yuan Zhang & Edward Lin – NVIDIA · 10 min read

[![](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/NVIDIA%20Multi-agent/blog-kernel-speedup.gif)](https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/NVIDIA%20Multi-agent/blog-kernel-speedup-1.mp4)

### Table of Contents

↑

* [Kernel optimization as a test of agent system capabilities](#kernel-optimization-as-a-test-of-agent-system-capabilities)
* [SOL-ExecBench for problem generation and benchmarking](#sol-execbench-for-problem-generation-and-benchmarking)
* [How we ran the experiment](#how-we-ran-the-experiment)
* [38% speedup, with 19% of optimizations exceeding 2x improvements](#38-speedup-with-19-of-optimizations-exceeding-2x-improvements)
* [Different optimization strategies for different problems](#different-optimization-strategies-for-different-problems)
* [BF16 Grouped Query Attention with Paged Prefill](#bf16-grouped-query-attention-with-paged-prefill)
* [NVFP4 MoE Linear with Gating](#nvfp4-moe-linear-with-gating)
* [BF16 Matrix Multiplication](#bf16-matrix-multiplication)
* [A multi-agent system for building software](#a-multi-agent-system-for-building-software)

Over the past few months, we've been developing a multi-agent system that can build, maintain, and deploy complex software autonomously. As part of that work, we've been testing the system in a variety of domains, including having it [build a browser from scratch](https://cursor.com/blog/scaling-agents) and solve a research-level math problem on the [First Proof benchmark](https://x.com/mntruell/status/2028903020847841336?s=20).
...
![SOL-ExecBench generated 235 optimization problems across LLM, diffusion, vision, audio, video, and multi-modal architectures](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fkernel-optimization-segmented-light.png&w=1920&q=70)![SOL-ExecBench generated 235 optimization problems across LLM, diffusion, vision, audio, video, and multi-modal architectures](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fkernel-optimization-segmented-dark.png&w=1920&q=70)
...
![The multi-agent system's autonomous debug, test, and optimization loop](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fdebug-test-loop-light.png&w=1920&q=70)![The multi-agent system's autonomous debug, test, and optimization loop](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fdebug-test-loop-dark.png&w=1920&q=70)
...
![Speed-of-Light score scale: 0.5 represents the optimized PyTorch baseline, 1.0 is the theoretical hardware limit](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fsol-score-light.png&w=1920&q=70)![Speed-of-Light score scale: 0.5 represents the optimized PyTorch baseline, 1.0 is the theoretical hardware limit](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fsol-score-dark.png&w=1920&q=70)
...
![Multi-agent system achieved 1.38x geometric mean speedup across 235 kernel optimization problems](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fspeedup-chart-light.png%3Fv%3D2&w=1920&q=70)![Multi-agent system achieved 1.38x geometric mean speedup across 235 kernel optimization problems](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fspeedup-chart-dark.png%3Fv%3D2&w=1920&q=70)

On 45 out of 235 problems (19%), the multi-agent system delivered optimizations greater than 2x compared to baselines. You can see the final solutions our system developed in this [public repo](https://github.com/anysphere/kernel-optimization-results).

![Distribution of per-problem speedups, with 19% exceeding 2x improvement](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fproblem-level-speedup-chart-light.png&w=1920&q=70)![Distribution of per-problem speedups, with 19% exceeding 2x improvement](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fproblem-level-speedup-chart-dark.png&w=1920&q=70)
...
![BF16 Grouped Query Attention optimization trajectory, reaching 0.9722 SOL score and 84% geomean speedup](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fevolution-trajectory-BF16-light.png&w=1920&q=70)![BF16 Grouped Query Attention optimization trajectory, reaching 0.9722 SOL score and 84% geomean speedup](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fevolution-trajectory-BF16-dark.png&w=1920&q=70)
...
![NVFP4 MoE Linear optimization trajectory, achieving 39% geomean speedup and 0.58 SOL score](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fevolution-trajectory-nvfp4-light.png%3Fv%3D2&w=1920&q=70)![NVFP4 MoE Linear optimization trajectory, achieving 39% geomean speedup and 0.58 SOL score](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fevolution-trajectory-nvfp4-dark.png%3Fv%3D2&w=1920&q=70)
...
![BF16 Matrix Multiplication results: 86% of human-optimized cuBLAS performance, outperforming on small-M cases by up to 9%](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fhuman-optimized-kernel-percentage-light.png&w=1920&q=70)![BF16 Matrix Multiplication results: 86% of human-optimized cuBLAS performance, outperforming on small-M cases by up to 9%](/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2FNVIDIA%2520Multi-agent%2Fhuman-optimized-kernel-percentage-dark.png&w=1920&q=70)
...
Authors: Wilson Lin, Sahil Modi, Yuan Zhang & Edward Lin
