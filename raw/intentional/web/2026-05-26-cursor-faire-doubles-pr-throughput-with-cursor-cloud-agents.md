...
canonical_url: "https://cursor.com/blog/faire/"
vendor_blog: cursor
...
Original URL: https://cursor.com/blog/faire/
...
May 26, 2026·[customers](/blog/topic/customers)
...
* [Cloud unlocks scaled agent parallelism](#cloud-unlocks-scaled-agent-parallelism)
* [Development environments give agents more autonomy](#development-environments-give-agents-more-autonomy)
* [Programmatic agents with Cursor Automations](#programmatic-agents-with-cursor-automations)
* [Automating legacy migrations with parallelized agents](#automating-legacy-migrations-with-parallelized-agents)
* [Standing up build previews in less than a day](#standing-up-build-previews-in-less-than-a-day)

Faire is an E-commerce company in North America.

2x

Increase in weekly PR throughput, driven by cloud agents

18 month

Migration for a full team reduced to one engineer and a fleet of agents

2,000+

Automated agent runs per week without any manual prompting

25+

Cursor Automations for bug fixes, CI investigations, and code review
...
If you're working on parallelizing your engineering velocity with cloud agents, [reach out to start a Cursor trial](https://cursor.com/contact-sales?source=customers).
