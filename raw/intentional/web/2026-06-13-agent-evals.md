...
Original URL: https://platform.openai.com/docs/guides/agent-evals
Fetched URL: https://platform.openai.com/docs/guides/agent-evals
Awesome Harness summary: OpenAI's product guide for measuring agent quality with reproducible task-level and workflow-level evaluations.
...
For code-first SDK workflows, start with [Integrations and observability](/api/docs/guides/agents/integrations-observability#tracing) to get high-signal traces before you formalize graders.
...
If you need advanced features such as evaluation against external models, evaluation APIs, or larger-scale batch evaluation, use [Evals](/api/docs/guides/evals) alongside datasets.

## Related evaluation surfaces

[Getting started with evals: Datasets

Operate a flywheel of continuous improvement using evaluations.](/api/docs/guides/evaluation-getting-started)
[Working with evals

Evaluate against external models, interact with evals via API, and more.](/api/docs/guides/evals)
[Prompt optimizer

Use your dataset to automatically improve your prompts.](/api/docs/guides/prompt-optimizer)
