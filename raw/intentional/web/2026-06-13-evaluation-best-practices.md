...
collected_at: 2026-06-13T10:49:46Z
...
Original URL: https://platform.openai.com/docs/guides/evaluation-best-practices
Fetched URL: https://platform.openai.com/docs/guides/evaluation-best-practices
Awesome Harness summary: OpenAI's general guide to building eval suites that match real-world distributions and catch regressions early.
...
page](/api/docs/deprecations#2026-06-03-evals-platform) for the current
timeline.
...
Using models to judge output is cheaper to run and more scalable than human evaluation. Start with [`gpt-5.5`](/api/docs/models/gpt-5.5) when you need a strong LLM judge, then validate agreement against your human labels before optimizing for cost or latency.
...
* **Recommendations**:
  ...
  + Use the most capable model to grade if you can. Start with [`gpt-5.5`](/api/docs/models/gpt-5.5), then validate whether a specialized reasoning model performs better for your rubric or reference-answer set
