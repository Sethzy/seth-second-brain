...
original_url: https://x.com/garrytan/status/2046876981711769720
author: "Garry Tan"
handle: garrytan
status_id: 2046876981711769720
captured_at: 2026-06-19T22:44:33+08:00
published_at: "Wed Apr 22 09:01:16 +0000 2026"
...
- Original: [https://x.com/garrytan/status/2046876981711769720](https://x.com/garrytan/status/2046876981711769720)
- Canonical: [https://x.com/garrytan/status/2046876981711769720](https://x.com/garrytan/status/2046876981711769720)
...
4. Five minutes later, searched my local knowledge base and found it instantly.
...
A resolver is a routing table for context: when task type X appears, load skill Y. I wrote about resolvers in detail [here](https://x.com/garrytan/status/2044479509874020852). Each skill needs a trigger entry in AGENTS.md, the file that teaches the agent what skills exist and when to use them.
...
1. Every skill directory with a SKILL.md has a corresponding entry in the resolver.

2. Every script referenced by a skill is actually callable (file exists, exports the right functions).

3. No two skills have overlapping trigger descriptions that would cause ambiguous routing.
...
The skillify pattern isn't specific to [OpenClaw](https://openclaw.ai/) or any particular harness. It's built into [GBrain](https://github.com/garrytan/gbrain). GBrain is the open source knowledge engine I wrote that sits underneath whatever harness you use. It manages your brain repo, runs your evals, and enforces the quality gates that make skills durable.
...
GStack to speed up in Claude Code [github.com/garrytan/gstack](https://github.com/garrytan/gstack) 

GBrain to build your own Jarvis from Iron Man in OpenClaw/Hermes Agent [github.com/garrytan/gbrain](https://github.com/garrytan/gbrain)

## X Article Metadata

- Title: How to really stop your agents from making the same mistakes
- Preview: LangChain has raised $160 million. Three years of development. A billion-dollar valuation. LangSmith, their testing platform, is genuinely sophisticated: trajectory evals, trace-to-dataset pipelines,
