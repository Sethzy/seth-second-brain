...
type: raw_capture
source_type: x
url: https://x.com/MrNobodySMC/status/2044611341512773747
original_url: https://x.com/MrNobodySMC/status/2044611341512773747
author: "Mr.Nobody"
handle: MrNobodySMC
status_id: 2044611341512773747
captured_at: 2026-06-20T01:04:32+08:00
published_at: "Thu Apr 16 02:58:25 +0000 2026"
...
# X post by @MrNobodySMC

## Source

- Original: [https://x.com/MrNobodySMC/status/2044611341512773747](https://x.com/MrNobodySMC/status/2044611341512773747)
- Canonical: [https://x.com/MrNobodySMC/status/2044611341512773747](https://x.com/MrNobodySMC/status/2044611341512773747)
- Author: Mr.Nobody (@MrNobodySMC)

## Verbatim Text

Currently having Claude Code learn geopolitical psychology (fundamentals)

so it can give that data to another agent which is tracking my buy/sell indicator,

which is tracking algorithmic levels (Fibonacci-math) to anticipate MMXM probabilities based on smart money behavior. https://t.co/ot45YdGqH8

## Quoted Post

- URL: https://x.com/Tradesdontlie/status/2039080409581891890
- Author: Andrew (@Tradesdontlie)
...
Beyond the obvious stuff like symbol, timeframe, and indicator values, Claude can read the actual drawing objects that Pine Script indicators put on your chart. The line.new() calls, label.new(), table.new(), box.new(). Anything your indicator draws on screen, Claude can read back as structured data. This works on protected indicators too. You just pass a filter targeting the indicator by name and you get back every price level, every text annotation, full table contents, every drawn zone.
...
That's the whole setup. Claude installs it, Claude runs it. You just describe what you want. The only thing limiting you is your creativity. 
...
- photo: https://pbs.twimg.com/media/HF_rLWYawAAVZGo.jpg
- photo: https://pbs.twimg.com/media/HF_rLWXbsAEw5qh.jpg
- photo: https://pbs.twimg.com/media/HF_rLWXbgAEQGtY.jpg
- photo: https://pbs.twimg.com/media/HF_rLWab0AAElpD.jpg
