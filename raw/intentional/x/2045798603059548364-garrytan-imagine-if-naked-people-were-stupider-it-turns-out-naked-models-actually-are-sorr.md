...
original_url: https://x.com/garrytan/status/2045798603059548364
author: "Garry Tan"
handle: garrytan
status_id: 2045798603059548364
captured_at: 2026-06-19T22:44:29+08:00
published_at: "Sun Apr 19 09:36:10 +0000 2026"
...
- Original: [https://x.com/garrytan/status/2045798603059548364](https://x.com/garrytan/status/2045798603059548364)
- Canonical: [https://x.com/garrytan/status/2045798603059548364](https://x.com/garrytan/status/2045798603059548364)
...
Some terms for readers who haven't read the [first essay in this series](https://x.com/garrytan/status/2042925773300908103). A skill file is a reusable markdown document that teaches the model how to approach a task — a procedure, not a prompt. A resolver is a routing table that tells the model which document to read for which task. Deterministic code is software that produces the same output every time — SQL queries, API calls, math — the parts the model should never touch. A harness is the thin conductor that runs the model in a loop, reads files, and manages context. Together: [thin harness, fat skills](https://x.com/garrytan/status/2042925773300908103).
...
In my own system, I designed my OpenClaw's brain resolver to be [80 lines of markdown](https://x.com/garrytan/status/2044479509874020852), in a numbered decision tree that routes every piece of knowledge to the right directory. When we didn't have it, skills made their own filing decisions and 10 out of 13 were wrong. When we added it, misfilings dropped to zero. The model didn't get smarter. The routing got explicit.
...
I open-sourced the architecture described in this series. [GBrain](https://github.com/garrytan/gbrain) is the knowledge layer to let you build your own personal OpenClaw/Hermes Agent that does work for you. [GStack](https://github.com/garrytan/gstack) is the skill layer to go fast with Claude Code.

## X Article Metadata

- Title: Imagine if naked people were stupider. It turns out, naked models actually are.
- Preview: Sorry, not that kind of naked model. But the disappointment you're feeling right now? That's exactly how Kyle Kingsbury feels about LLMs.
Kyle Kingsbury is one of the best systems engineers alive. His
