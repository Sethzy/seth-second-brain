...
original_url: https://x.com/hwchase17/status/2021261552222158955
author: "Harrison Chase"
handle: hwchase17
status_id: 2021261552222158955
captured_at: 2026-06-19T20:17:43+08:00
published_at: "Tue Feb 10 16:34:41 +0000 2026"
...
- Original: [https://x.com/hwchase17/status/2021261552222158955](https://x.com/hwchase17/status/2021261552222158955)
- Canonical: [https://x.com/hwchase17/status/2021261552222158955](https://x.com/hwchase17/status/2021261552222158955)
...
- [deepagents](https://docs.langchain.com/oss/python/deepagents/overview) supports both patterns with simple configuration
...
Note: this post focuses on sandboxes that give agents a full 'computer’ - complete execution environments like Docker containers or VMs. We won't cover process-level sandboxes (like [bubblewrap](https://github.com/containers/bubblewrap)) or language-level sandboxes (like [Pyodide](https://pyodide.org/en/stable/)).
...
Your agent runs locally (or on your server), and when it generates code that needs to execute, it calls out to a sandbox provider's API (like [E2B](https://e2b.dev/), [Modal](https://modal.com/), [Daytona](https://www.daytona.io/), or [Runloop](https://runloop.ai/)). The provider's SDK handles all the communication details. From your agent's perspective, the sandbox is just another tool.
...
To make these patterns concrete, we'll show examples using [deepagents](https://docs.langchain.com/oss/python/deepagents/overview), an open-source agent framework with built-in sandbox support. Similar patterns apply to other agent frameworks.
...
deepagents supports both patterns with simple configuration. [Try it out](https://github.com/langchain-ai/deepagents) to see which pattern works best for your use case.
...
- Preview: TL;DR:
More and more agents need a workspace: a computer where they can run code, install packages, and access files. Sandboxes provide this.
There are two architecture patterns for integrating agents
