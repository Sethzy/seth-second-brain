...
original_url: https://x.com/juliandeangeiis/status/2033303156340240481
author: "Juli\u00e1n"
handle: juliandeangeIis
status_id: 2033303156340240481
captured_at: 2026-06-19T21:44:08+08:00
published_at: "Sun Mar 15 22:03:44 +0000 2026"
...
- Original: [https://x.com/juliandeangeiis/status/2033303156340240481](https://x.com/juliandeangeiis/status/2033303156340240481)
- Canonical: [https://x.com/juliandeangeIis/status/2033303156340240481](https://x.com/juliandeangeIis/status/2033303156340240481)
...
1. Spec-First: write a spec before coding, but discard it after delivery. Most start here, and it already eliminates the ambiguity problem for that cycle.

2. Spec-Anchored: the spec lives in the repo alongside the code and evolves with it. Specs become living documentation for the team.

3. Spec-as-Source: the spec is the primary artifact. You edit the spec, code is regenerated to match. This is the frontier, we're not fully there yet, but it's where the trajectory points.
...
- Preview: The Spec Is the New Code
AI coding agents don’t fail because the model is weak. They fail because the instructions are ambiguous and the agent harness is too weak.
